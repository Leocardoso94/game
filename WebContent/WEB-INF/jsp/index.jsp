...
<body>
	...
	<a href="#perguntaNumero5">teste</a>
		<section id="inicio">
			<div class="row">
			...
			<div class="row">
				<p class="text-center">
					...
					Lembre de anotar as respostas que utilizar, isso será de grande valia
				</p>
			</div>
		</section>
		<c:forEach items="${tarefas}" var="tarefa">
			...
			<c:choose>
				<c:when test="${tarefa.situacao}">					
					<c:import url="${tarefa.id}.jsp" />
				</c:when>
				<c:otherwise>
					<i class="text-center fa fa-lock center-block" aria-hidden="true"></i>
				</c:otherwise>
			</c:choose>
			</section>
		</c:forEach>
